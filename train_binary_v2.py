...
callbacks = [
    ...
    ModelCheckpoint(
        "models/bone_binary_model_v2.keras",
        monitor="val_accuracy",
        save_best_only=True
    )
]
...
print("\nDONE: MobileNetV2 model saved.")
print("Saved files:")
print("- models/bone_binary_model.keras")
print("- reports/accuracy_graph.png")
print("- reports/loss_graph.png")
